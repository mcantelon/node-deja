...
exports.findUnusedBasename = function(dejaHome, repoUrl, callback, counter) {
  ...
  fs.exists(dejaHome + '/' + basename, function(exists) {
...
exports.clone = function(repoUrl, pathToRepo, successCallback) {
  ...
  clone.on('exit', function(code) {
    ...
    if (code != 0) {
      ...
      fs.exists(pathToRepo + '/.gitmodules', function(exists) {
...
exports.outputEntryAndInfo = function(entry, pathToRepo, pathToEntry) {
  ...
  fs.exists(pathToEntry, function(exists) {
...
exports.spawnThenExit = function(params) {

  var env = (params.env) ? params.env : process.env

  process.stdin.pause()

  var job = spawn(params.command, params.arguments, {
    cwd: params.cwd,
    env: env,
    stdio: [
      0,
...
exports.getIgnoreList = function(home, repo, callback) {
  ...
  fs.exists(pathToGlobalIgnore, function(exists) {
    ...
    fs.exists(pathToRepoIgnore, function(exists) {
